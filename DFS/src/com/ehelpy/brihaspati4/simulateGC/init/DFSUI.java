package com.ehelpy.brihaspati4.simulateGC.init;

import com.ehelpy.brihaspati4.dfs3Ufs1Core.dfs3Mgr.Dfs3Download;
import com.ehelpy.brihaspati4.dfs3Ufs1Core.dfs3Mgr.DFS3ListFiles;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
        btnDfsUpload.addActionListener(e -> {
            ...
            try {
                boolean flag = com.ehelpy.brihaspati4.dfs3Ufs1Core.dfs3Mgr.DFS3Upload.start(true);//reference to Upload.start()
                JFrame frame;
                frame = new JFrame();
                if(flag)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
        btnUfsUpload.addActionListener(e -> {
            //call the Upload class once user clicks on Upload
            try {
                boolean flag = com.ehelpy.brihaspati4.dfs3Ufs1Core.dfs3Mgr.DFS3Upload.start(false);//reference to Upload.start()
                JFrame frame;
                frame = new JFrame();
                if(flag)
                    JOptionPane.showMessageDialog(frame,"Upload successful!","Brihaspati-4 DFS/UFS",JOptionPane.PLAIN_MESSAGE);
