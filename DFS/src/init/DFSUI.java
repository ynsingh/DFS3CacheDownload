...
public class DFSUI extends JFrame {
    ...
    private JMenuItem dfsUpload, dfsDownload, ufsUpload, ufsDownload;
    private JButton btnDfsUpload, btnDfsDownload, btnUfsUpload, btnUfsDownload;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
        btnDfsUpload.addActionListener(e -> {
            ...
            try {
                boolean flag = start(true);//reference to Upload.start()
                JFrame frame;
                frame = new JFrame();
                if(flag)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
        btnUfsUpload.addActionListener(e -> {
            //call the Upload class once user clicks on Upload
            try {
                boolean flag = start(false);//reference to Upload.start()
                JFrame frame;
                frame = new JFrame();
                if(flag)
                    JOptionPane.showMessageDialog(frame,"Upload successful!","Brihaspati-4 DFS/UFS",JOptionPane.PLAIN_MESSAGE);
